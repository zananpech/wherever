...
function Contact() {
  return (
    <div
      onMouseEnter={() => viewTrackingHandler("fourth-view")}
      class="container md:flex justify-center items-center h-screen w-screen mt-5"
    >
      <div class="mx-16">
        ...
        <Animated animationInDelay="800">
          <p class="lg:text-2xl text-xl">
            We are not ready to fully roll out <br /> wherever company, but sign
            up and we'll <br /> keep you posted.
          </p>
        </Animated>
        <Animated animationInDelay="800">
          <form class="mt-8 flex">
            <input
              class="rounded-lg p-4 border-t mr-0 border-b border-l text-gray-800 border-gray-200 bg-white"
      ...
      <div class="lg:w-1/2 lg:h-3/5 mt-26">
        <img
          class="mx-auto lg:w-max lg:h-max"
          src={require("../assets/notify.gif")}
        />
      </div>
    </div>
  );
